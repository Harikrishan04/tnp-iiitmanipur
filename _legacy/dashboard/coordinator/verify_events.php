...
<body class="bg-gray-100 min-h-screen">
            ...
            <main class="flex-1 flex flex-col min-h-0 p-4 md:p-8 w-full">
                <div class="flex flex-1 gap-6 min-h-0">
                    ...
                    <div class="w-full md:w-2/3 bg-white rounded-lg shadow-lg flex flex-col p-6 min-h-0">
                        <div id="eventDetails" class="flex flex-1 flex-col items-center justify-center text-gray-400 overflow-y-auto overflow-scroll">
    ...
    // NEW: Function to handle message actions (Verify/Modify/Reject)
    async function handleMessageAction(action, eventId) {
        ...
        try {
            ...
            const response = await fetch(apiUrl, {
                ...
                body: `event_id=${eventId}&status=${action === 'modify' ? 'resubmit' : action}&remark=${encodeURIComponent(message)}&coordinator_id=<?php echo $coordinatorId; ?>`,
                credentials: 'include',
            });
