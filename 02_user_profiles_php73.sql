-- Part 2: User Profile Tables (PHP 7.3+ Compatible)
...
-- Add JSON indexes if MySQL version supports it (8.0.13+)
-- These will be created conditionally in the application layer for PHP 7.3 compatibility
