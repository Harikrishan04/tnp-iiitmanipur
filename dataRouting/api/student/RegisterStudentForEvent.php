...
require_once '../../config/db.php'; // Adjust path if necessary based on your actual config location

// Check if the user is logged in and is a student
// For production, uncomment and ensure strict checking
/*
...
// For demonstration/testing, use a default user_id if session is not set
$participant_id = $_SESSION['user_id'] ?? 'a1b2c3d4-e5f6-7890-1234-567890abcdef'; // Ensure this matches a student_id in your DB
